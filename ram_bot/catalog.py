...
NSFW_CATEGORY = CategoryInfo(
    ...
    commands=(
        ...
        CommandInfo("maid", "maid", "Fetch a generic explicit maid-themed Gelbooru image using your preset filters.", nsfw_only=True),
        CommandInfo("rammaid", "rammaid", "Fetch an explicit Ram maid-themed Gelbooru image using your preset filters.", nsfw_only=True),
        CommandInfo("remmaid", "remmaid", "Fetch an explicit Rem maid-themed Gelbooru image using your preset filters.", nsfw_only=True),
