...
NSFW_CATEGORY = CategoryInfo(
    ...
    commands=(
        ...
        CommandInfo("ram", "ram", "Fetch an explicit Ram maid-themed Gelbooru image using your preset filters.", nsfw_only=True),
        CommandInfo("rem", "rem", "Fetch an explicit Rem maid-themed Gelbooru image using your preset filters.", nsfw_only=True),
